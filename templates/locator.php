...
<section id="store" class="store-locator">
	...
	<section class="category box-full sl-slider pb mnt" role="region"
		aria-label="<?php esc_attr_e('Lista negozi presenti nell\'area interessata', 'store-locator'); ?>">

		<div class="slide-intro d-mid-none my">
			<p class="h3"><?php echo $sl_icon_html; // safe: built above with esc_url 
							?><?php echo esc_html($suggerimenti_title); ?></p>
		...
		<div class="slide-box">
			...
			<div class="slide-btns d-sm-none" style="margin-top: 50px;">
